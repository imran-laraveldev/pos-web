<!doctype html>
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" lang="en" data-layout="vertical" data-topbar="light"
data-sidebar="dark" data-sidebar-size="lg" data-sidebar-image="none" data-preloader="disable" data-layout-mode="light"
...
<head>
    ...
    <link href="{{ asset('assets-cattle/assets/css/custom.min.css') }}" rel="stylesheet" type="text/css"/>
    <link rel="stylesheet" href="{{asset('assets-cattle/datatable/css/dataTables.bs4.css')}}"/>
    <link rel="stylesheet" href="{{asset('assets-cattle/datatable/css/dataTables.bs4-custom.css')}}"/>
    ...
    <div class="main-content">
        ...
        <div class="page-content">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div id="notification_alert" style="display: none"></div>
...
<!-- JAVASCRIPT -->
<script type="text/javascript" src="{{ asset('assets-cattle/js/jquery-3.6.0.min.js')}}" ></script>

<script src="{{ asset('assets-cattle/assets/libs/bootstrap/js/bootstrap.bundle.min.js') }}"></script>
...
<script type="text/javascript" src="{{ asset('assets-cattle/js/printThis.js')}}"></script>
